...
1. In the command line, navigate to the src directory by running `cd src`

2. Compile the ReadFile.java file by running `javac ReadFile.java`

## Instructions on how to run the code

1. Run the executable file `ReadFile.class` by running `java ReadFile <filename.in>`, 
